...
\hlstd{rawYield} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{)\{}
  \hlkwd{return}\hlstd{(x}\hlopt{$}\hlstd{paddock.cowpea.yield)}
\hlstd{\}}

\hlstd{cowpeaY} \hlkwb{<-} \hlkwd{apsimSEN}\hlstd{(}\hlkwc{X} \hlstd{= X1,} \hlkwc{exe} \hlstd{= exe,} \hlkwc{wd} \hlstd{= wd,} \hlkwc{vars} \hlstd{= vars,} \hlkwc{toRun} \hlstd{= file,} \hlkwc{g} \hlstd{= rawYield,} \hlkwc{overwrite} \hlstd{=} \hlnum{TRUE}\hlstd{)}
