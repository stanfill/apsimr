...
\title{\pkg{apsimr}: Edit, run and evaluate APSIM simulations from R easily}
...
\hlstd{X1} \hlkwb{<-} \hlkwd{data.frame}\hlstd{(}\hlkwc{SoilCN}\hlstd{=}\hlkwd{runif}\hlstd{(n,} \hlnum{5}\hlstd{,} \hlnum{25}\hlstd{),} \hlkwc{DiffusConst} \hlstd{=} \hlkwd{runif}\hlstd{(n,} \hlnum{20}\hlstd{,} \hlnum{50}\hlstd{),} \hlkwc{CNCov} \hlstd{=} \hlkwd{runif}\hlstd{(n,} \hlnum{0}\hlstd{,} \hlnum{1}\hlstd{))}
\hlstd{X2} \hlkwb{<-} \hlkwd{data.frame}\hlstd{(}\hlkwc{SoilCN}\hlstd{=}\hlkwd{runif}\hlstd{(n,} \hlnum{5}\hlstd{,} \hlnum{25}\hlstd{),} \hlkwc{DiffusConst} \hlstd{=} \hlkwd{runif}\hlstd{(n,} \hlnum{20}\hlstd{,} \hlnum{50}\hlstd{),} \hlkwc{CNCov} \hlstd{=} \hlkwd{runif}\hlstd{(n,} \hlnum{0}\hlstd{,} \hlnum{1}\hlstd{))}

\hlstd{sobolRes} \hlkwb{<-} \hlkwd{soboljansen}\hlstd{(apsimSEN, X1, X2,} \hlkwc{exe}\hlstd{=exe,} \hlkwc{wd}\hlstd{=wd,} \hlkwc{vars}\hlstd{=vars,}\hlkwc{toRun}\hlstd{=file,} \hlkwc{g}\hlstd{=meanYield,} \hlkwc{overwrite}\hlstd{=}\hlnum{TRUE}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
