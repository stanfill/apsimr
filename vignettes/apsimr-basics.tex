...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{edit_apsim}\hlstd{(file, apsimWD, var, value,} \hlkwc{overwrite} \hlstd{=} \hlnum{FALSE}\hlstd{)}
\end{alltt}
\end{kframe}
\end{knitrout}
...
\hlstd{meanYield}\hlkwb{<-}\hlkwa{function}\hlstd{(}\hlkwc{x}\hlstd{)\{}
  \hlkwd{return}\hlstd{(}\hlkwd{mean}\hlstd{(x}\hlopt{$}\hlstd{cowpea.yield))}
\hlstd{\}}
...
\hlstd{sobolResults} \hlkwb{<-} \hlkwd{soboljansen}\hlstd{(}\hlkwc{model} \hlstd{= apsim_sen, X1, X2,} \hlkwc{exe} \hlstd{= apsimExe,} \hlkwc{wd} \hlstd{= apsimWD,}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlstd{emulRes} \hlkwb{<-} \hlkwd{apsim_emulator}\hlstd{(}\hlkwc{model} \hlstd{= apsim_sen,} \hlkwc{X} \hlstd{= X1,} \hlkwc{method} \hlstd{=} \hlstr{"singleGAM"}\hlstd{,} \hlkwc{exe} \hlstd{= apsimExe,} \hlkwc{wd} \hlstd{= apsimWD,}
                        \hlkwc{vars} \hlstd{= vars,} \hlkwc{toRun} \hlstd{= file,} \hlkwc{g} \hlstd{= meanYield,} \hlkwc{overwrite} \hlstd{=} \hlnum{TRUE}\hlstd{)}
...
\hlstd{cowpeaY} \hlkwb{<-} \hlkwd{apsim_sen}\hlstd{(}\hlkwc{X} \hlstd{= X1,} \hlkwc{exe} \hlstd{= apsimExe,} \hlkwc{wd} \hlstd{= apsimWD,} \hlkwc{vars} \hlstd{= vars,} \hlkwc{toRun} \hlstd{= file,} \hlkwc{g} \hlstd{= rawYield,} \hlkwc{overwrite} \hlstd{=} \hlnum{TRUE}\hlstd{)}
